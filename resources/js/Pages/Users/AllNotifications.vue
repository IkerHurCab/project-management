...
<template>
  <Layout pageTitle="All Notifications">
    <div class="min-h-screen bg-black text-gray-300 dark:bg-gray-100 dark:text-gray-700">
      <!-- Main Content -->
      <div class="p-6">
        <!-- Header with stats -->
        <div class="mb-6">
          <h1 class="text-2xl font-bold text-white dark:text-black mb-2">Notifications</h1>
          <div class="flex justify-between w-full gap-4">
            <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg w-full  p-4 border border-gray-700 flex items-center gap-3">
              <div class="w-10 h-10 bg-blue-600/20 rounded-lg flex items-center justify-center">
                <box-icon name='bell' color='#3B82F6'></box-icon>
              </div>
              <div>
                <p class="text-gray-400 text-xs">Total</p>
                <p class="text-xl font-bold text-white dark:text-black">{{ totalCount }}</p>
              </div>
            </div>
            ...
            <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg w-full p-4 border border-gray-700 flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xl font-bold text-white dark:text-black">{{ unreadCount }}</p>
              </div>
            </div>

            <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg p-4 w-full border border-gray-700 flex items-center gap-3">
              <div class="w-10 h-10 bg-green-600/20 rounded-lg flex items-center justify-center">
                <box-icon name='time' color='#10B981'></box-icon>
              </div>
              <div>
                <p class="text-gray-400 text-xs">Today</p>
                <p class="text-xl font-bold text-white dark:text-black">{{ todayCount }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Filters -->
        <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg border border-gray-700 mb-6">
          <div class="p-4 border-b border-gray-700">
            <h2 class="text-lg font-semibold text-white dark:text-black">Filters</h2>
          </div>
          <div class="p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input id="search" v-model="searchQuery" type="text" placeholder="Search notifications..."
                    class="bg-gray-900 dark:bg-gray-100 dark:text-black border border-gray-700 text-white rounded-md pl-10 pr-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                </div>
              </div>
              ...
              <div>
                ...
                <select id="type-filter" v-model="filterType"
                  class="bg-gray-900 border border-gray-700 dark:bg-gray-100 dark:text-black text-white rounded-md px-4 py-2.5 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div>
                ...
                <select id="read-filter" v-model="filterRead"
                  class="bg-gray-900 border border-gray-700 text-white dark:bg-gray-100 dark:text-black rounded-md px-4 py-2.5 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="flex justify-between mt-4">
              <button @click="resetFilters"
                class="px-4 py-2 bg-gray-800 dark:bg-gray-200 dark:hover:bg-gray-300 dark:text-black text-white rounded-md hover:bg-gray-700 transition-colors cursor-pointer flex items-center gap-2">
                <box-icon name='reset' :color="checkDarkMode() ? 'black' : 'white'" size="sm"></box-icon>
                Reset Filters
              </button>
        ...
        <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg border border-gray-700 mb-6">
          <div class="p-4 border-b border-gray-700 flex justify-between items-center">
            <h2 class="text-lg font-semibold text-white dark:text-black">
              {{ filteredNotifications.length }} {{ filteredNotifications.length === 1 ? 'Notification' : 'Notifications' }}
            </h2>
            <div class="flex items-center space-x-2">
              <select v-model="itemsPerPage"
                class="bg-gray-900 text-white dark:text-black dark:bg-gray-100 border border-gray-700 rounded px-2 py-1 text-sm">
          ...
          <div v-if="filteredNotifications.length === 0" class="p-12 flex flex-col items-center justify-center">
            <div class="w-16 h-16 bg-gray-800 dark:bg-gray-100 rounded-full flex items-center justify-center mb-4">
              <box-icon name='bell-off' color='#9CA3AF' size="md"></box-icon>
            </div>
            <h3 class="text-lg font-medium text-white dark:text-black mb-2">No notifications found</h3>
            <p class="text-gray-400 text-center max-w-md">
              There are no notifications matching your current filters. Try changing your filter settings or check back
              later.
            </p>
            <button @click="resetFilters"
          ...
          <div v-else class="divide-y divide-gray-800">
            <div v-for="notification in paginatedNotifications" :key="notification.id"
              class="p-6 hover:bg-gray-900 dark:hover:bg-gray-100 transition-colors"
              :class="{ 'bg-gray-900 dark:bg-gray-100 bg-opacity-40': !notification.is_read }">
                  ...
                  <div class="flex flex-col justify-between h-full">
                    <div>
                      <div class="flex items-center justify-between">
                        <h3 class="font-medium text-base  dark:text-black"
                          :class="{ 'text-white dark:text-black': !notification.is_read, 'text-gray-300': notification.is_read }">
                          {{ notification.title }}
                        </h3>
          ...
          <div v-if="filteredNotifications.length > 0"
            class="px-6 py-4 bg-gray-900 dark:bg-gray-100 border-t border-gray-800 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-1">
              ...
              <button v-for="page in getPageNumbers(currentPage, totalPages)" :key="page" @click="goToPage(page)"
                :class="[
