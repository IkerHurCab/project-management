        ...
        <div v-if="modalCreateDepartment">
            <div v-if="modalCreateDepartment"
                ...
                <div class="bg-gray-800 dark:bg-white p-8 rounded-lg shadow-lg w-1/3"
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-300 dark:text-gray-700">Name</label>
                    ...
                    <div class="mb-4">
                        <label for="description" class="block text-sm font-medium text-gray-300 dark:text-gray-700">Description</label>
                    ...
                    <div class="mb-4">
                        <label for="department_head" class="block text-sm font-medium text-gray-300 dark:text-gray-700">Department
                            Head</label>
