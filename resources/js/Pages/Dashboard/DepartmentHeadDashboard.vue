...
const taskPriorityChartOptions =computed(() => ( {
  ...
  grid: {
    borderColor: checkDarkMode() ? '#000000' : '#E5E7EB',
  },
  legend: {
    show: false
  }
...
const progressChartOptions = computed(() => ({
  chart: {
    type: 'radialBar',
    background: 'transparent',
    foreColor: checkDarkMode() ? '#000000' : '#E5E7EB',
  },
  plotOptions: {
    radialBar: {
      hollow: {
...
<template>
  <Layout pageTitle="Department Head Dashboard">
    <div class="min-h-screen bg-black dark:bg-gray-100 rounded-lg dark:text-gray-700 text-gray-300">
      ...
      <div class="p-6">
          ...
          <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                ...
                <h3 class="text-3xl font-bold text-white dark:text-black mt-1">{{ totalProjects }}</h3>
              </div>
            ...
            <div class="mt-4 flex items-center text-sm">
              ...
              <span class="text-blue-500 dark:text-blue-600 flex items-center">
          ...
          <div class="bg-gray-950 dark:bg-white dark:border-none dark:shadow-xl rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                ...
                <h3 class="text-3xl font-bold text-white dark:text-black mt-1">{{ totalTasks }}</h3>
              </div>
          ...
          <div class="bg-gray-950 dark:bg-white rounded-lg p-6 dark:border-none dark:shadow-xl border border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                ...
                <h3 class="text-3xl font-bold text-white  dark:text-black mt-1">{{ uniqueTeamMembers.length }}</h3>
              </div>
          ...
          <div class="bg-gray-950 dark:bg-white rounded-lg p-6 dark:border-none dark:shadow-xl border border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                ...
                <h3 class="text-3xl font-bold text-white dark:text-black mt-1">{{ overallProgress }}%</h3>
              </div>
              <div class="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <!-- Project Status Chart -->
          <div class="bg-gray-900 dark:bg-white rounded-lg overflow-hidden dark:border-none dark:shadow-xl border border-gray-700">
          ...
          <!-- Task Priority Chart -->
          <div class="bg-gray-900 dark:bg-white rounded-lg dark:border-none dark:shadow-xl overflow-hidden border border-gray-700">
            <div class="border-b-2 border-dashed border-gray-700 dark:border-none px-6 py-4">
          ...
          <div class="bg-gray-900  dark:bg-white rounded-lg dark:border-none dark:shadow-xl overflow-hidden border border-gray-700">
            ...
            <div class="p-6 bg-gray-950 dark:bg-white h-full">
                ...
                <div v-for="task in urgentTasks" :key="task.id"
                  ...
                  <div class="flex justify-between items-start">
                    <div>
                      ...
                      <p class="text-gray-400 text-sm mt-1 darj:text-gray-700">{{ task.project_name }}</p>
                    </div>
                  ...
                  <div class="mt-3 flex items-center justify-between">
                    <div class="flex items-center">
                      ...
                      <span class="text-sm text-gray-300 dark:text-gray-700">{{ getPriorityLabel(task.priority) }}</span>
                    </div>
              ...
              <div v-else class="flex flex-col items-center justify-center h-64">
                ...
                <p class="text-gray-400 dark:text-gray-700 mt-4">No urgent tasks at the moment</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Project Timeline -->
        <div class="bg-gray-900 dark:bg-white rounded-lg dark:border-none dark:shadow-xl overflow-hidden border border-gray-700 mb-6">
        ...
        <div class="bg-gray-900  dark:bg-white rounded-lg dark:border-none dark:shadow-xl overflow-hidden border border-gray-700 mb-6">
          <div class="border-b border-gray-700 px-6 py-4 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-white dark:text-black">Active Projects</h2>
            <div class="flex items-center space-x-2">
              <select v-model="projectItemsPerPage"
                class="bg-gray-800 dark:bg-gray-100 dark:text-black text-white border border-gray-700 rounded px-2 py-1 text-sm">
            ...
            <table class="w-full">
              <thead>
                <tr class="bg-gray-800 dark:bg-gray-100 border-b border-gray-700 text-left">
                  ...
                  <th class="p-4 font-semibold text-gray-400 dark:text-gray-700">Team Size</th>
                  <th class="p-4 font-semibold text-gray-400 dark:text-gray-700">Progress</th>
                  <th class="p-4 font-semibold text-gray-400 dark:text-gray-700">Deadline</th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="project in paginatedProjects" :key="project.id" @click="navigateToProject(project.id)"
                  ...
                  <td class="p-4 text-gray-300 dark:text-gray-600">{{ formatDate(project.end_date) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="px-6 py-4 bg-gray-900 dark:bg-white border-t border-gray-800 flex items-center justify-between">
            <div class="text-sm text-gray-400">
              Showing {{ paginatedProjects.length }} of {{ activeProjects.length }} projects
            </div>
            <div class="flex items-center space-x-1">
              <button @click="prevPage(projectCurrentPage, 'projects')" :disabled="projectCurrentPage === 1"
              ...
              <button v-for="page in getPageNumbers(projectCurrentPage, projectTotalPages)" :key="page"
                @click="goToPage(page, projectCurrentPage, projectTotalPages, 'projects')" :class="[
              ...
              <button @click="nextPage(projectCurrentPage, projectTotalPages, 'projects')"
        ...
        <div class="bg-gray-900  dark:bg-white rounded-lg dark:border-none dark:shadow-xl overflow-hidden border border-gray-700">
          <div class="border-b border-gray-700 px-6 py-4 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-white dark:text-black">Team Performance</h2>
            <div class="flex items-center space-x-2">
              <select v-model="teamItemsPerPage"
                class="bg-gray-800 text-white dark:text-black dark:bg-gray-100 border border-gray-700 rounded px-2 py-1 text-sm">
                <option :value="5">5 per page</option>
                <option :value="10">10 per page</option>
                <option :value="15">15 per page</option>
              </select>
            ...
            <table class="w-full">
              <thead>
                <tr class="bg-gray-800 border-b border-gray-700 dark:bg-gray-200 text-left">
                  ...
                  <th class="p-4 font-semibold text-gray-400 dark:text-gray-700">Tasks Completed</th>
                  <th class="p-4 font-semibold text-gray-400 dark:text-gray-700">Completion Rate</th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="member in paginatedTeamMembers" :key="member.id"
                  ...
                  <td class="p-4">
                    <div class="flex items-center space-x-3">
                      ...
                      <span class="text-white dark:text-black">{{ member.name }}</span>
                    </div>
                  </td>
                ...
                <tr v-if="paginatedTeamMembers.length === 0">
                  <td colspan="4" class="p-4 text-center text-gray-400 dark:bg-gray-700">No hay miembros del equipo para mostrar</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="px-6 py-4 bg-gray-900 dark:bg-white border-t border-gray-800 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-1">
              <button @click="prevPage(teamCurrentPage, 'teamMembers')" :disabled="teamCurrentPage === 1"
              ...
              <button v-for="page in getPageNumbers(teamCurrentPage, teamTotalPages)" :key="page"
                @click="goToPage(page, teamCurrentPage, teamTotalPages, 'teamMembers')" :class="[
              ...
              <button @click="nextPage(teamCurrentPage, teamTotalPages, 'teamMembers')"
