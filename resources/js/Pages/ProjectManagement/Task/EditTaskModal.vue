  ...
  <template>
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div class="bg-gray-950 rounded-lg w-full max-w-md p-6 border border-gray-700 shadow-lg">
        <h3 class="text-xl font-semibold text-white mb-4">Are you sure you want to delete this task?</h3>
        ...
        <div class="flex justify-end space-x-4">
          ...
          <StandardButton @click="deleteTask" class="bg-red-600 hover:bg-red-500 transition-colors">
            Delete
          </StandardButton>
        </div>
      </div>
