    ...
    <div class="min-h-screen w-full flex">
        ...
        <div class="w-full md:w-1/3 bg-gray-950 border-l border-gray-600 min-h-screen flex items-center justify-center">
            <form @submit.prevent="login"
                ...
                <InputWithIcon v-model="form.email" name="email" icon="alternate_email" placeholder="Correo electrónico" class="w-full"
                    type="email" required autocomplete="off"/>
                <InputWithIcon v-model="form.password" name="password" icon="lock" placeholder="Contraseña" type="password" class="w-full"
